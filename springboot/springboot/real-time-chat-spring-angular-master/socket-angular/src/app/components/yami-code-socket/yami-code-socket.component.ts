...
export class YamiCodeSocketComponent implements OnInit {
  ...
  sendMessageUsingSocket() {
    if (this.form.valid) {
      let message: Message = { message: this.form.value.message, fromId: this.userForm.value.fromId, elephant: this.userForm.value.elephant };
  ...
  sendMessageUsingRest() {
    if (this.form.valid) {
      let message: Message = { message: this.form.value.message, elephant: this.userForm.value.elephant, fromId: this.userForm.value.fromId };
